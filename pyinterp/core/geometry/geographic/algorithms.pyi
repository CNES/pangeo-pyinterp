...
@overload
def transform_to_box(geometry: Box) -> Box: ...
@overload
def transform_to_box(geometry: Point) -> Box: ...
@overload
def transform_to_linestring(geometry: LineString) -> LineString: ...
@overload
def transform_to_linestring(geometry: Segment) -> LineString: ...
@overload
def transform_to_multilinestring(
    geometry: MultiLineString,
) -> MultiLineString: ...
@overload
def transform_to_multilinestring(geometry: Ring) -> MultiLineString: ...
@overload
def transform_to_multilinestring(geometry: Polygon) -> MultiLineString: ...
@overload
def transform_to_multilinestring(
    geometry: MultiPolygon,
) -> MultiLineString: ...
@overload
def transform_to_multilinestring(geometry: Segment) -> MultiLineString: ...
@overload
def transform_to_multilinestring(geometry: LineString) -> MultiLineString: ...
@overload
def transform_to_multipoint(geometry: MultiPoint) -> MultiPoint: ...
@overload
def transform_to_multipoint(geometry: Box) -> MultiPoint: ...
@overload
def transform_to_multipoint(geometry: LineString) -> MultiPoint: ...
@overload
def transform_to_multipoint(geometry: Ring) -> MultiPoint: ...
@overload
def transform_to_multipoint(geometry: Polygon) -> MultiPoint: ...
@overload
def transform_to_multipoint(geometry: MultiPolygon) -> MultiPoint: ...
@overload
def transform_to_multipoint(geometry: MultiLineString) -> MultiPoint: ...
@overload
def transform_to_multipoint(geometry: Point) -> MultiPoint: ...
@overload
def transform_to_multipolygon(geometry: MultiPolygon) -> MultiPolygon: ...
@overload
def transform_to_multipolygon(geometry: Box) -> MultiPolygon: ...
@overload
def transform_to_multipolygon(geometry: Ring) -> MultiPolygon: ...
@overload
def transform_to_multipolygon(geometry: Polygon) -> MultiPolygon: ...
def transform_to_point(geometry: Point) -> Point: ...
@overload
def transform_to_polygon(geometry: Polygon) -> Polygon: ...
@overload
def transform_to_polygon(geometry: Box) -> Polygon: ...
@overload
def transform_to_polygon(geometry: Ring) -> Polygon: ...
@overload
def transform_to_ring(geometry: Ring) -> Ring: ...
@overload
def transform_to_ring(geometry: Box) -> Ring: ...
@overload
def transform_to_ring(geometry: Polygon) -> Ring: ...
def transform_to_segment(geometry: Segment) -> Segment: ...
@overload
def union(
    geometry1: Ring,
    geometry2: Ring,
