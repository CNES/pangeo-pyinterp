...
class TestBivariate(TestCase):
    ...
    def test_nearest(self):
        self._test(core.cartesian.Nearest(), "mss_cartesian_nearest")

    def test_bilinear(self):
        self._test(core.cartesian.Nearest(), "mss_cartesian_bilinear")

    def test_idw(self):
        self._test(core.cartesian.Nearest(), "mss_cartesian_idw")
