...
Create a GeoHash from its string representation.
...
Raises:
    ValueError: If the code is not a valid geohash.
      ...
      .def("bounding_box", &geohash::GeoHash::bounding_box,
           R"__doc__(
Return the bounding box of this GeoHash.
...
Returns:
    Bounding box.
      ...
      .def("center", &geohash::GeoHash::center,
           R"__doc__(
Return the center point of this GeoHash.
...
Returns:
    Precision.
      ...
      .def("number_of_bits", &geohash::GeoHash::number_of_bits,
           R"__doc__(
Return the number of bits of this GeoHash.
...
Returns:
    Number of bits.
      ...
      .def("__str__", &geohash::GeoHash::string_value,
           R"__doc__(
Return the string representation of this GeoHash.
...
Returns:
    Calculated area in square meters.
      ...
      .def("reduce", &geohash::GeoHash::reduce,
           R"__doc__(
Return the arguments to rebuild this instance.
...
Returns:
    Longitude and latitude precisions.
      ...
      .def_static("grid_properties", &geohash::GeoHash::grid_properties,
                  ...
                  R"__doc__(
Get the property of the grid covering the given box.
...
Return the accuracy in longitude/latitude and degrees for the given precision.
