...
auto init_multipoint(nb::module_& m) -> void {
  nb::class_<MultiPoint>(m, "MultiPoint", kMultiPointClassDoc)
      ...
      .def(
          ...
          "Return the informal string representation of the MultiPoint.")
      ...
      .def(
          ...
          "Return the state of the MultiPoint for pickling.")
      ...
      .def(
          ...
          "state"_a, "Restore the state of the MultiPoint from pickling.");
