...
"""Tests for geographic geometric type transformation algorithms."""
...
def test_transform_point_to_point(point_basic: Point) -> None:
    ...
    assert result.lon == point_basic.lon
    assert result.lat == point_basic.lat
